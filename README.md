# ig-trading-workshop-reactjs
Repository containing the code for the Ig frontend workshop
* Add workshop description and steps here.
* Delete create react app decription?
